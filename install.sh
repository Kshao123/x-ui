...
curl -L -o /usr/local/x-ui-linux-${cpu}.tar.gz -# --retry 2 --https://ghproxy.net/insecure https://raw.githubusercontent.com/yonggekkk/x-ui-yg/main/x-ui-linux-${cpu}.tar.gz
...
curl -L -o /usr/bin/x-ui -# --retry 2 --https://ghproxy.net/insecure https://raw.githubusercontent.com/yonggekkk/x-ui-yg/main/install.sh
...
curl -https://ghproxy.net/sL https://raw.githubusercontent.com/yonggekkk/x-ui-yg/main/version | awk -F "更新内容" '{print $1}' | head -n 1 > /usr/local/x-ui/v
showxuiip
sleep 2
xuigo
cronxui
...
green "x-ui已卸载完成"
echo
blue "欢迎继续使用x-ui-yg脚本：bash <(curl -https://ghproxy.net/Ls https://raw.githubusercontent.com/yonggekkk/x-ui-yg/main/install.sh)"
echo
else
red "输入有误" && uninstall
fi
...
bbr() {
bash <(curl -https://ghproxy.net/Ls https://raw.githubusercontent.com/teddysun/across/master/bbr.sh)
back
}
...
curl -L -o /usr/local/x-ui/xuiwpph -# --retry 2 --https://ghproxy.net/insecure https://raw.githubusercontent.com/yonggekkk/x-ui-yg/main/xuiwpph_$cpu
...
latestV=$(curl -sL https://ghproxy.net/https://raw.githubusercontent.com/yonggekkk/x-ui-yg/main/version | awk -F "更新内容" '{print $1}' | head -n 1)
...
echo -e "${yellow}$(curl -sL https://ghproxy.net/https://raw.githubusercontent.com/yonggekkk/x-ui-yg/main/version)${plain}"
